...
import { ISubtracaoCommandI } from '../../shared/numeros-inteiros.model';
import { ServicoNumerosInteiros } from '../../shared/numeros-inteiros.service';

@Component({
  selector: 'ifmath-ni-subtracao',
  templateUrl: './ni-subtracao.component.html',
  styleUrls: ['./ni-subtracao.component.scss']
})
export class NiSubtracaoComponent implements OnInit {
  ...
  onSubmit(): void {
    this.loading = true;
    const numerosNaturais: ISubtracaoCommandI = this.form.value;
