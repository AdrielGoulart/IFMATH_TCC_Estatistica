...
import { ISubtracaoComand } from '../../shared/numeros-naturais.model';
import { ActivatedRoute } from '@angular/router';

@Component({
  templateUrl: './nn-subtracao.component.html',
  styleUrls: ['./nn-subtracao.component.scss']
})

export class NnSubtracaoComponent implements OnInit {
  ...
  onSubmit(): void {
    this.loading = true;
    const numerosNaturais: ISubtracaoComand = this.form.value;
