...
@Component({
  ...
  templateUrl: './est-grafico-quant-colunas-e-linhas.component.html',
  styleUrls: ['./est-grafico-quant-colunas-e-linhas.component.scss']
})
export class EstGraficoQuantColunasELinhasComponent implements OnInit {
