...
@Component({
  ...
  templateUrl: './est-grafico-quant-polig-freq.component.html',
  styleUrls: ['./est-grafico-quant-polig-freq.component.scss']
})
export class EstGraficoQuantPoligFreqComponent implements OnInit {
