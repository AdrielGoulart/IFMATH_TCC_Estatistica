...
@Component({
  ...
  templateUrl: './cf-angulo-central.component.html',
  styleUrls: ['./cf-angulo-central.component.scss']
})
export class CfAnguloCentralComponent implements AfterViewInit {
  ...
  ngDoCheck() {
    ...
    if (this.angle.toString().length == 1) degree.style.marginLeft = '38px';
    else if (this.angle.toString().length == 2) degree.style.marginLeft = '43px';
    else if (this.angle.toString().length == 3) degree.style.marginLeft = '48px';
    else if (this.angle.toString().length == 4) degree.style.marginLeft = '53px';
