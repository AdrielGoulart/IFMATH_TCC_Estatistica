...
@Component({
  ...
  templateUrl: './est-grafico-quant-linhas.component.html',
  styleUrls: ['./est-grafico-quant-linhas.component.scss']
})
export class EstGraficoQuantLinhasComponent implements OnInit {
