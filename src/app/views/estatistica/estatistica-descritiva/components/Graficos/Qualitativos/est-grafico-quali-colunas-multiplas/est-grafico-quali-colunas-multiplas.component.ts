...
@Component({
  ...
  templateUrl: './est-grafico-quali-colunas-multiplas.component.html',
  styleUrls: ['./est-grafico-quali-colunas-multiplas.component.scss']
})
export class EstGraficoQualiColunasMultiplasComponent implements OnInit {
