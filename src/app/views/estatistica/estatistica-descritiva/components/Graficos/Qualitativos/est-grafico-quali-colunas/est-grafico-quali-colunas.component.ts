...
@Component({
  ...
  templateUrl: './est-grafico-quali-colunas.component.html',
  styleUrls: ['./est-grafico-quali-colunas.component.scss']
})
export class EstGraficoQualiColunasComponent implements OnInit {
