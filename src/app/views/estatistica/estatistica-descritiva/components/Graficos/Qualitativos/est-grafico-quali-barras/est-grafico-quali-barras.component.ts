...
@Component({
  ...
  templateUrl: './est-grafico-quali-barras.component.html',
  styleUrls: ['./est-grafico-quali-barras.component.scss']
})
export class EstGraficoQualiBarrasComponent implements OnInit {
