...
@Component({
  selector: 'ifmath-est-grafico-colunas',
  templateUrl: './est-grafico-colunas.component.html',
  styleUrls: ['./est-grafico-colunas.component.scss']
})
export class EstGraficoColunasComponent implements OnInit {
